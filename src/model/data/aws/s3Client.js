/**
 * This file will configure the S3 SDK, so that we can issues commands.
 * We're going to write this code in such a way that we can easily swap the implementation of S3 that we use at runtime.
